...
if ENCODING:
    ...
    dataN_pkl_file_agent = open(
        './data/01072020(143650)_data01072020(142210)_agentNNdriven01192020(010736)_twoboxCol.pkl',
        'rb')

    dataN_pkl_file_IRC = open('./data/01072020(143650)_data01072020(142210)_agentNN01192020(010736)_IRC2_twoboxCol.pkl',
                              'rb')
